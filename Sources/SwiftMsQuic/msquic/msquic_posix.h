...
#ifdef __cplusplus
#define QUIC_FAILED(X)                  (static_cast<int>(X) > 0)
#define QUIC_SUCCEEDED(X)               (static_cast<int>(X) <= 0)
#else
...
#ifdef __cplusplus
#define QUIC_STATUS_DEF(x) (static_cast<QUIC_STATUS>(x))
#else
#define QUIC_STATUS_DEF(x) ((QUIC_STATUS)(x))
#endif

#define QUIC_STATUS_SUCCESS                 QUIC_STATUS_DEF(0)               // 0
#define QUIC_STATUS_PENDING                 QUIC_STATUS_DEF(-2)              // -2
#define QUIC_STATUS_CONTINUE                QUIC_STATUS_DEF(-1)              // -1
#define QUIC_STATUS_OUT_OF_MEMORY           QUIC_STATUS_DEF(ENOMEM)          // 12
#define QUIC_STATUS_INVALID_PARAMETER       QUIC_STATUS_DEF(EINVAL)          // 22
#define QUIC_STATUS_INVALID_STATE           QUIC_STATUS_DEF(EPERM)           // 1
#define QUIC_STATUS_NOT_SUPPORTED           QUIC_STATUS_DEF(EOPNOTSUPP)      // 95   (102 on macOS)
#define QUIC_STATUS_NOT_FOUND               QUIC_STATUS_DEF(ENOENT)          // 2
#define QUIC_STATUS_FILE_NOT_FOUND          QUIC_STATUS_NOT_FOUND            // 2
#define QUIC_STATUS_BUFFER_TOO_SMALL        QUIC_STATUS_DEF(EOVERFLOW)       // 75   (84 on macOS)
#define QUIC_STATUS_HANDSHAKE_FAILURE       QUIC_STATUS_DEF(ECONNABORTED)    // 103  (53 on macOS)
#define QUIC_STATUS_ABORTED                 QUIC_STATUS_DEF(ECANCELED)       // 125  (89 on macOS)
#define QUIC_STATUS_ADDRESS_IN_USE          QUIC_STATUS_DEF(EADDRINUSE)      // 98   (48 on macOS)
#define QUIC_STATUS_INVALID_ADDRESS         QUIC_STATUS_DEF(EAFNOSUPPORT)    // 97   (47 on macOS)
#define QUIC_STATUS_CONNECTION_TIMEOUT      QUIC_STATUS_DEF(ETIMEDOUT)       // 110  (60 on macOS)
#define QUIC_STATUS_CONNECTION_IDLE         QUIC_STATUS_DEF(ETIME)           // 62   (101 on macOS)
#define QUIC_STATUS_INTERNAL_ERROR          QUIC_STATUS_DEF(EIO)             // 5
#define QUIC_STATUS_CONNECTION_REFUSED      QUIC_STATUS_DEF(ECONNREFUSED)    // 111  (61 on macOS)
#define QUIC_STATUS_PROTOCOL_ERROR          QUIC_STATUS_DEF(EPROTO)          // 71   (100 on macOS)
#define QUIC_STATUS_VER_NEG_ERROR           QUIC_STATUS_DEF(EPROTONOSUPPORT) // 93   (43 on macOS)
#define QUIC_STATUS_UNREACHABLE             QUIC_STATUS_DEF(EHOSTUNREACH)    // 113  (65 on macOS)
#define QUIC_STATUS_TLS_ERROR               QUIC_STATUS_DEF(ENOKEY)          // 126
#define QUIC_STATUS_USER_CANCELED           QUIC_STATUS_DEF(EOWNERDEAD)      // 130  (105 on macOS)
#define QUIC_STATUS_ALPN_NEG_FAILURE        QUIC_STATUS_DEF(ENOPROTOOPT)     // 92   (42 on macOS)
#define QUIC_STATUS_STREAM_LIMIT_REACHED    QUIC_STATUS_DEF(ESTRPIPE)        // 86
#define QUIC_STATUS_ALPN_IN_USE             QUIC_STATUS_DEF(EPROTOTYPE)      // 91   (41 on macOS)
#define QUIC_STATUS_ADDRESS_NOT_AVAILABLE   QUIC_STATUS_DEF(EADDRNOTAVAIL)   // 99   (47 on macOS)

#define QUIC_STATUS_TLS_ALERT(Alert)        QUIC_STATUS_DEF((0xff & Alert)+ TLS_ERROR_BASE)
...
#define QUIC_STATUS_CERT_ERROR(Val)         QUIC_STATUS_DEF(Val + CERT_ERROR_BASE)
